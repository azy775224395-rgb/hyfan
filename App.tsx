      ...
      default:
        return (
          <div className="flex flex-col gap-0 pb-16 md:pb-32">
            <SEO
              title="الرئيسية | أبو إيفان للطاقة المتجددة - حلول طاقة شمسية وتجهيزات ابو ايفان"
              description="موقع أبو إيفان للطاقة المتجددة يقدم أفضل حلول طاقة شمسية في اليمن. تسوق ألواح شمسية ابو ايفان، بطاريات، إنفرترات، وأنظمة طاقة شمسية للمنازل بأفضل الأسعار وتقنيات حديثة من متجر ابو ايفان (Abu Ivan)."
            />
            <VideoPromo />
