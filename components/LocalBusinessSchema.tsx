...
const LocalBusinessSchema: React.FC = () => {
  const schema = {
    ...
    alternateName: ["Abu Ivan", "Abu Ivan Energy", "متجر ابو ايفان", "ابو ايفان", "الواح ابو ايفان", "متجر أبو إيفان", "Abu Evan"],
    image:
      "https://res.cloudinary.com/dxzqizvzw/image/upload/v1779209369/IMG_%D9%A2%D9%A0%D9%A2%D9%A6%D9%A0%D9%A5%D9%A1%D9%A9_%D9%A1%D9%A9%D9%A2%D9%A5%D9%A4%D9%A2_kji9am.png",
    ...
    priceRange: "$$",
    description:
      "شركة رائدة في مجال الطاقة الشمسية في اليمن، توفر ألواح طاقة شمسية، بطاريات جل، انفرترات، وأجهزة منزلية موفرة للطاقة مع شحن لجميع المحافظات.",
    address: {
      "@type": "PostalAddress",
