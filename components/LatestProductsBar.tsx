       ...
       >
         {latestProducts.map((product) => (
           <MotionLink
             ...
             whileTap={{ scale: 0.96 }}
             className="min-w-[110px] max-w-[110px] md:min-w-[130px] md:max-w-[130px] bg-white rounded-xl border border-gray-100 overflow-hidden snap-start flex-shrink-0 cursor-pointer hover:shadow-lg hover:shadow-primary/5 hover:border-primary/20 transition-all group block"
