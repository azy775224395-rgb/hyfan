...
const GlassProductCard: React.FC<GlassProductCardProps> = ({ product, onAddToCart, onViewDetails, onOrderNow, formatPrice }) => {
  return (
    <motion.div 
      ...
      className="group relative bg-white/40 backdrop-blur-xl border border-white/60 rounded-[2rem] shadow-sm hover:shadow-2xl hover:shadow-emerald-900/10 transition-all duration-300 cursor-pointer h-full hover:-translate-y-1"
    >
