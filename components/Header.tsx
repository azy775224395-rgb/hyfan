    ...
    <header className="sticky top-0 z-40 w-full bg-white/40 backdrop-blur-2xl border-b border-emerald-100 shadow-xl shadow-emerald-900/5">
      <div className="container mx-auto px-3 h-14 md:h-24 flex items-center justify-between gap-2 md:gap-6">
        ...
        <div className="flex-grow max-w-md relative group">
          ...
          />
          <svg className="absolute right-2.5 md:right-5 top-1/2 -translate-y-1/2 text-emerald-300 group-focus-within:text-emerald-600 transition-colors" xmlns="http://www.w3.org/2000/svg" width="14" height="14" md:width="22" md:height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>
        </div>
